	...
	namespace Graphics {
		namespace Rendering {
			...
			namespace RenderPipelines {
				...
				Lit::Lit(I::IGraphicsAPI* pAPI, void* renderPass)
				{
...
#pragma region DEFAULT_PIPELINE_STATE
					...
					vk->CompileShader("assets/shaders/lit.glsl", wireframeShader, _countof(shaderStages), shaderStages);
...
#pragma endregion
				...
				void Lit::OnResize(uint32_t nwidth, uint32_t nheight)
				{
					width = nwidth;
					height = nheight;
				}

				void Lit::OnBind(void* pCmdBuffer)
				{
				...
				void Lit::OnUpdateUniforms(void* pPuffer)
				{
					UBO ubo = *static_cast<UBO*>(pPuffer);
				...
				void Lit::OnPushConstants(void* pCmd, void* pConstants)
				{
