	...
	namespace Graphics {
		namespace Rendering {
			...
			namespace RenderPipelines {
				...
				Wireframe::Wireframe(I::IGraphicsAPI* pAPI, void* renderPass)
				{
...
#pragma endregion
				...
				void Wireframe::OnUpdateUniforms(void* data)
				{
				...
				void Wireframe::OnResize(uint32_t nwidth, uint32_t nheight)
				{
					width = nwidth;
					height = nheight;
				}

				void Wireframe::OnBind(void* pCmdBuffer)
				{
				...
				void Wireframe::OnPushConstants(void* pCmd, void* pConstants)
				{
