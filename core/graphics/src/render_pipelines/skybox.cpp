	...
	namespace Graphics {
		namespace Rendering {
			...
			namespace RenderPipelines {
				...
				Skybox::Skybox(I::IGraphicsAPI* pAPI, void* renderPass)
				{
...
#pragma region DEFAULT_PIPELINE_STATE
					...
					vk->CompileShader("assets/shaders/skybox.glsl", wireframeShader, _countof(shaderStages), shaderStages);
...
#pragma endregion
				...
				void Skybox::OnUpdateUniforms(void* data)
				{
				...
				void Skybox::OnResize(uint32_t nwidth, uint32_t nheight)
				{
					width = nwidth;
					height = nheight;
				}

				void Skybox::OnBind(void* pCmdBuffer)
				{
				...
				void Skybox::OnPushConstants(void* pCmd, void* pConstants)
				{
